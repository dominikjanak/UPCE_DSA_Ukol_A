...
namespace Ukol_A
{
    public partial class Form1 : Form
    {
        ...
        private void InstantlyDrawGraph()
        {
            ...
            _drawer.DrawEdge(crossroads[8], crossroads[9], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[8], landings[0], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[8], crossroads[1], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[1], crossroads[7], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[1], crossroads[7], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[3], crossroads[2], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[2], crossroads[0], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[7], crossroads[5], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[9], crossroads[5], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[5], crossroads[10], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[10], crossroads[14], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[5], crossroads[11], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[2], crossroads[6], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[6], crossroads[12], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[0], crossroads[6], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[0], crossroads[5], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[10], crossroads[11], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[4], crossroads[3], EdgeType.Blocked, "25");
            _drawer.DrawEdge(crossroads[4], landings[1], EdgeType.Blocked, "25");
            ...
            _drawer.DrawEdge(stops[0], crossroads[3], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[0], crossroads[2], EdgeType.Free, "25");
            _drawer.DrawEdge(landings[1], crossroads[2], EdgeType.Free, "25");
            _drawer.DrawEdge(landings[0], crossroads[5], EdgeType.Free, "25");
            _drawer.DrawEdge(landings[2], crossroads[0], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[1], crossroads[6], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[3], crossroads[5], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[3], crossroads[10], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[1], crossroads[11], EdgeType.Free, "25");
            _drawer.DrawEdge(landings[2], crossroads[13], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[1], crossroads[14], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[1], crossroads[12], EdgeType.Free, "25");
            _drawer.DrawEdge(stops[1], crossroads[13], EdgeType.Blocked, "25");
            _drawer.DrawEdge(crossroads[0], crossroads[7], EdgeType.Free, "25");

            _drawer.DrawEdge(crossroads[6], landings[2], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[11], landings[2], EdgeType.Free, "25");
            _drawer.DrawEdge(crossroads[11], crossroads[14], EdgeType.Free, "25");

            _drawer.DrawPath(landings[0], crossroads[5]);
            _drawer.DrawPath(crossroads[5], crossroads[11]);
            _drawer.DrawPath(crossroads[11], stops[1]);
